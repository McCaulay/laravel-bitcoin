...
class GenerateApi extends Api
{
     ...
     *
     * @param $blocks The number of blocks to generate. The RPC call will not return until all blocks
     *                have been generated or the maxium number of iterations has been reached
     * @param $maxTries The maximum number of iterations that are tried to create the requested number
